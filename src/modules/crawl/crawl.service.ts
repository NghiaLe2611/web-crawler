        ...
        try {
            browser = await puppeteer.launch({
                ...
                args: [
                    ...
                    // '--single-process',
                    // Thêm các args này để fix detached frame
            ...
            // Đảm bảo dom có table
            // await page.waitForSelector('.table-mini-result tbody tr', { timeout: 20000 });
            ...
            console.log('scrapeData error:', error);
            return null;
